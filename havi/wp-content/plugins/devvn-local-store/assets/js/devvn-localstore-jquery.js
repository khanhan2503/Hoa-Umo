        ...
        function dvls_ajax_load_success(response){
            ...
            if(response.success) {
                ...
                for (var i = 0; i < maps_data.length; i++)
                {
                    ...
                    $html += '<p class="store_address">'+dataMarker['address']+'</p>';
                    $html += '<p>';
                    if(dataMarker['hotline1']) {
                        $html += '<a class="store_phone" href="tel:'+dataMarker['hotline1']+'">'+dataMarker['hotline1']+'</a>';
                    }
                    ...
                    $html += '</p>';
                    $html += '<p class="store_open">'+dataMarker['open']+'</p>';
                    $html += '<a style="color:#0E8BDD " href="https://maps.google.com?saddr=Current+Location&daddr='+lat+','+lng+'" target="_blank" rel="nofollow">Đường đi</a>';
                    $html += '</div>';
                    $html += '</div>';
